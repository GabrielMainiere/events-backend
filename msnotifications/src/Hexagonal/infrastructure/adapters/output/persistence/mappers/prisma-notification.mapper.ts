...
import { NotificationProps } from 'src/Hexagonal/domain/factories/types/notification.types';

export class PrismaNotificationMapper {
  
  static toPrisma(notification: Notification): Omit<PrismaNotificationLog, 'created_at'> {
    return {
      id: notification.id,
